--Second version of the procedure with error handling. Still under development.
DELIMITER //
CREATE PROCEDURE debit_withdraw(IN pAccountId VARCHAR(20), IN pAmount DECIMAL(10,2) )
BEGIN
